...
HIP_VISIBLE_DEVICES=7 rocprofv3 --hip-runtime-trace --kernel-trace --output-format csv pftrace -d trace_casual_conv1d -o matrix_out_m_1024_n_32_k_128 --stats -- ./build_casual_conv1d_test/matrix_core_casual_conv1d.exe
